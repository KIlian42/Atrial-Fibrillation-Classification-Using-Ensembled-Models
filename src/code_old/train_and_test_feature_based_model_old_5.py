...
def main():
    ...
    oversample_strategy = {0: 1500, 1: 1500, 2: 1500, 3: 1500, 4: 1500}  # Reduce class x to n
    ...
    undersample_strategy = {0: 94, 1: 94, 2: 94, 3: 94, 4: 94}  # Reduce class x to n
    ...
    sns.heatmap(
        cm, annot=True, fmt="d", cmap="Blues", xticklabels=["SR", "AF", "AFL", "PAC", "PVC"], yticklabels=["SR", "AF", "AFL", "PAC", "PVC"]
    )
    fig = plt.gcf()
    ...
    plt.savefig(
        "ConfusionMatrix_Physionet2021_featureBased_5.png"
    )
    plt.show()
