...
10. Investigation of interesting library for deep learning forecasting, called "Darts", collection of different models, i.e. TCNN and Transformer models for timeseries forecasting: https://github.com/unit8co/darts
